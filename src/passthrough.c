...
#define DEV_CONSOLE DEVICE_DT_GET(DT_CHOSEN(uart_host))
...
static void passthrough_thread(void);
K_THREAD_DEFINE(passthrough_thread_id, 1024, passthrough_thread, NULL, NULL, NULL, 6, 0, 0);
